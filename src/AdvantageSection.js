            ...
            <div className="row mb-4">
                <div className="col-12 text-center aos-init aos-animate" data-aos="fade-up" data-aos-delay="0">
                    ...
                    <div className="row">
                        ...
                        <div className="col-md-6 mb-4 aos-init aos-animate" data-aos="fade-up" data-aos-delay="200">
                            <div className="row">
                                <div class="col-md-2 service-icon2 text-light rounded-3 fs-5 text-center ms-2" style={{ width: 40, height:40 }}>
                        ...
                        <div className="col-md-6 mb-4 aos-init aos-animate" data-aos="fade-up" data-aos-delay="300">
                            <div className="row">
                            <div class="col-md-2 service-icon3 text-light rounded-3 fs-5 text-center ms-2" style={{ width: 40, height:40 }}>
                        ...
                        <div className="col-md-6 mb-4 aos-init aos-animate" data-aos="fade-up" data-aos-delay="400">
                            <div className="row">
                            <div class="col-md-2 service-icon4 text-light rounded-3 fs-5 text-center ms-2" style={{ width: 40, height:40 }}>
