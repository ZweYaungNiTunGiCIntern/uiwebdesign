  ...
  return (
        <div className="container mt-5 pt-5">
          <div className="row justify-content-between align-items-center">
            ...
            <div
              className="col-lg-6 order-lg-first mb-5"
              data-aos-once="true"
              data-aos="fade-up"
              data-aos-delay="200"
            >
            ...
            <div className="col-lg-5 order-lg-last mb-3 " >
              <div className="row feature mb-3"  data-aos="fade-left" data-aos-duration="800" data-aos-once="true" >
                <div className="col-2 service-icon1 text-light rounded-3 d-flex align-items-center" style={{ height: 40, width: 40 }}>
              ...
              <div className="row feature mb-3"  data-aos="fade-left" data-aos-delay="100" data-aos-duration="800" data-aos-once="true">

                <div className="col-2 service-icon2 text-light rounded-3 d-flex align-items-center" style={{ height: 40, width: 40 }}>
              ...
              <div className="row feature mb-3"  data-aos="fade-left" data-aos-delay="200" data-aos-duration="800" data-aos-once="true">

                <div className="col-2 service-icon3 text-light  rounded-3 d-flex align-items-center" style={{ height: 40, width: 40 }}>
              ...
              <div className="row feature mb-3"  data-aos="fade-left" data-aos-delay="300" data-aos-duration="800" data-aos-once="true">
                <div className="col-2 service-icon4 text-light rounded-3 d-flex align-items-center" style={{ height: 40, width: 40 }}>
