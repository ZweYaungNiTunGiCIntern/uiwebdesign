    ...
    <div className="container mt-5 mb-5">
        <div className="row justify-content-center">
            <div className="col-md-6">
                <img src={mbm} alt="Image Description" className="img-fluid"/>
            </div>
            <div className="col-md-6">
                    <a href="#" class="service link horizontal d-flex aos-init aos-animate active text-decoration-none text-dark" data-aos="fade-left" data-aos-delay="0" data-index="1">
                    <div class="service-icon1 text-light rounded-3 fs-5 text-center ms-2" style={{ width: 40, height:40 }}>
                    ...
                    <a href="#" className="d-flex text-decoration-none text-dark">
                    <div class="service-icon1 text-light rounded-3 fs-5 text-center ms-2" style={{ width: 40, height:40 }}>
                    ...
                    <a href="#" className="d-flex text-decoration-none text-dark">
                    <div class="service-icon2 text-light rounded-3 fs-5 text-center ms-2" style={{ width: 40, height:40 }}>
                    ...
                    <a href="#" className="d-flex text-decoration-none text-dark">
                    <div class="service-icon4 text-light rounded-3 fs-5 text-center ms-2" style={{ width: 40, height:40 }}>
