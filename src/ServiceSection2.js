            ...
            <div class="container mt-5 mb-5">
                <div class="row">
                    <div class="col-md-6 mb-4 mb-lg-0 col-lg-3" data-aos="fade-up" data-aos-delay="0">
                        <div class="service">
                            <div class="service-icon1 text-light rounded-3 fs-5 text-center ms-2 mb-2" style={{ width: 40, height:40 }}>
                            ...
                            <div class="col-md-6 mb-4 mb-lg-0 col-lg-3 aos-init aos-animate" data-aos="fade-up" data-aos-delay="100">
                                <div class="service">
                                <div class="service-icon2 text-light rounded-3 fs-5 text-center ms-2 mb-2" style={{ width: 40, height:40 }}>
                            ...
                            <div class="service">
                                <div class="service-icon3 text-light rounded-3 fs-5 text-center ms-2 mb-2" style={{ width: 40, height:40 }}>
                            ...
                            <div class="col-md-6 mb-4 mb-lg-0 col-lg-3 aos-init aos-animate" data-aos="fade-up" data-aos-delay="300">
                                <div class="service">
                                    <div class="service-icon4 text-light rounded-3 fs-5 text-center ms-2 mb-2" style={{ width: 40, height:40 }}>
